...
|status| ![img3](https://img.shields.io/badge/codeORANGE-not%20installable(in_maintanenece)-orange) visit [v00-snapshot](https://github.com/RandomCoderOrg/ubuntu-on-android/tree/v00-snapshot) for previous version |
